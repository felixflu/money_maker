...
**YOU ARE IN: `money_maker/polecats/garnet/`** — This is YOUR worktree. Stay here.
...
**Your mail address:** `money_maker/polecats/garnet`
...
| Ask Witness for help | `gt mail send money_maker/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`money_maker/witness`) when:
...
```bash
gt mail send money_maker/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
