...
async def validate_connection(
    ...
    try:
        ...
        elif validation_data.exchange_name == "mexc":
            client = MexcClient(
                api_key=validation_data.api_key,
                api_secret=validation_data.api_secret,
            )
